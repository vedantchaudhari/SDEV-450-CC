...
public class AdelsonVelskyLandisTree<E extends Comparable<E>> extends BinarySearchTree<E> {

    /**
     * Create a default AVL tree
     */
    public AdelsonVelskyLandisTree() { }
     ...
     * @param <E>
     */
    protected static class AVLTreeNode<E extends Comparable<E>> extends BinarySearchTree.TreeNode<E> {
